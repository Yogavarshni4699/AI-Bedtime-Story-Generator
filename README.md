...
My info:
🎯 How It Works
User Prompt → Storyteller generates Story V1
Judge evaluates → Provides feedback + metrics + decision
Storyteller → Creates Story V2 (auto-refined)
Show to User → Display revised story
(Optional) User Feedback → User suggests changes
Storyteller → Creates Story V3 (user-revised)
Judge → Final re-evaluation
Final Story → Delivered!
